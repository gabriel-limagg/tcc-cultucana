...
export default function Apresentacao() {
  return (
    ...
    <div className='px-4 md:px-8'>
      <h1 className=' font-RedRose  md:pt-56 text-textColor text-4xl md:text-5xl text-center  md:-mt-40'>
      ...
      <section>
        <div className='flex flex-col md:flex-row justify-between mt-20 md:mt-36 space-y-12 md:space-y-0 md:space-x-8'>
          <div className='md:w-1/4 text-center'>
            <h1 className='font-RedRose text-textColor text-4xl md:text-4xl'>Sobre Nós:</h1>
          ...
          <div className='md:w-1/4 text-center'>
            <h1 className='font-RedRose text-textColor text-4xl md:text-4xl'>Nossa Missão:</h1>
            <p className='font-lilita text-lg md:text-xl mt-4 md:mt-8 text-stone-300'>
          ...
          <div className='md:w-1/4 text-center'>
            <h1 className='font-RedRose text-textColor text-4xl md:text-4xl'>O que Oferecemos:</h1>
            <p className='font-lilita text-lg md:text-xl mt-4 md:mt-8 text-stone-300'>
        ...
        <div className=' font-RedRose mt-10 md:mt-20'>
          <h1 className='text-textColor text-4xl md:text-4xl text-center md:my-10'>Por Que Escolher Nosso Sistema:</h1>
        ...
        <div>
          <h1 className='font-RedRose mt-10 p-8 text-textColor text-4xl md:text-4xl text-left'>Veja Nosso Sistema em Ação:</h1>
        </div>

        <div className=' flex flex-col md:flex-row justify-between items-center mt-10 md:mt-20 space-y-4 md:p-8 px-16'>
          <img src={img} alt="" className='  md:w-1/5 md:mr-4 md:ml-4' />
          <img src={img2} alt="" className=' md:w-1/5 md:mr-4 md:ml-4' />
          <img src={img3} alt="" className=' md:w-1/5 md:mr-4 md:ml-4' />
        </div>
      </section>
    </div>
  )
